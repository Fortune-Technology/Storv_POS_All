...
//   tsconfig coverage expansion. Strict typing of one-shot migration scripts
//   deferred to Phase 5 (alongside strict-Prisma typing). Remove this when
//   the file gets audited; expect ~9 errors all mechanical (param annotations
//   + a Prisma where-clause null/undefined narrowing).
