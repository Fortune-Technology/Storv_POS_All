...
/* NOTE (storefront-only fork): the ConfirmModal.css side-import lives in
 * pages/_app.tsx because Next.js disallows global CSS imports from any
 * file other than the entry. Portal/cashier-app/admin-app keep the
 * component-level `import './ConfirmModal.css'` since they're Vite. */
